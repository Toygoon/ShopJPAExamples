...
class ItemRepositoryTest {
    ...
    public void findItemByDetailTest() {
        this.createItemTest();
        List<Item> itemList = itemRepository.findItemByDetail("테스트 상품 상세 설명" + (new Random().nextInt() % TEST_ITEMS + 1));
    ...
    public void findItemByDetailNative() {
        this.createItemTest();
        List<Item> itemList = itemRepository.findItemByDetailNative("테스트 상품 상세 설명" + (new Random().nextInt() % TEST_ITEMS + 1));
